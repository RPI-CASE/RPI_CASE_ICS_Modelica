...
PERL=perl
MAINFILE=Buildings_getLatitudeTMY3_5.c

.PHONY: Buildings_getLatitudeTMY3_5
Buildings_getLatitudeTMY3_5: $(MAINFILE) Buildings_getLatitudeTMY3_5.h Buildings_getLatitudeTMY3_5_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getLatitudeTMY3_5.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getLatitudeTMY3_5_records.o Buildings_getLatitudeTMY3_5_records.c
	 $(LINK) -o Buildings_getLatitudeTMY3_5$(DLLEXT) Buildings_getLatitudeTMY3_5.o Buildings_getLatitudeTMY3_5_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm