...
PERL=perl
MAINFILE=Buildings_getLatitudeTMY3_16.c

.PHONY: Buildings_getLatitudeTMY3_16
Buildings_getLatitudeTMY3_16: $(MAINFILE) Buildings_getLatitudeTMY3_16.h Buildings_getLatitudeTMY3_16_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getLatitudeTMY3_16.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getLatitudeTMY3_16_records.o Buildings_getLatitudeTMY3_16_records.c
	 $(LINK) -o Buildings_getLatitudeTMY3_16$(DLLEXT) Buildings_getLatitudeTMY3_16.o Buildings_getLatitudeTMY3_16_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm