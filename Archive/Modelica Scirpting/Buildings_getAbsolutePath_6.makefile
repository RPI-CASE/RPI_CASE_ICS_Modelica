...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_6.c

.PHONY: Buildings_getAbsolutePath_6
Buildings_getAbsolutePath_6: $(MAINFILE) Buildings_getAbsolutePath_6.h Buildings_getAbsolutePath_6_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_6.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_6_records.o Buildings_getAbsolutePath_6_records.c
	 $(LINK) -o Buildings_getAbsolutePath_6$(DLLEXT) Buildings_getAbsolutePath_6.o Buildings_getAbsolutePath_6_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm