...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_11.c

.PHONY: Buildings_getAbsolutePath_11
Buildings_getAbsolutePath_11: $(MAINFILE) Buildings_getAbsolutePath_11.h Buildings_getAbsolutePath_11_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_11.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_11_records.o Buildings_getAbsolutePath_11_records.c
	 $(LINK) -o Buildings_getAbsolutePath_11$(DLLEXT) Buildings_getAbsolutePath_11.o Buildings_getAbsolutePath_11_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm