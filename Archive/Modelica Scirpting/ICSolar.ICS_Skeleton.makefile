...
CPPFLAGS= -I"C:/OpenModelica1.9.1//include/omc/c" -I. -DOPENMODELICA_XML_FROM_FILE_AT_RUNTIME
LDFLAGS=-L"C:/Users/Justin/Documents/GitHub/RPI_CASE_ICS_Modelica" -L"C:/OpenModelica1.9.1//lib/omc" -L"C:/OpenModelica1.9.1//lib" -Wl,--stack,0x2000000,-rpath,"C:/OpenModelica1.9.1//lib/omc" -Wl,-rpath,"C:/OpenModelica1.9.1//lib"   -lregex -lexpat -lgc -lpthread -fopenmp -loleaut32  -lSimulationRuntimeC -lgc -lexpat -lregex -static-libgcc -luuid -loleaut32 -lole32 -lws2_32 -lsundials_kinsol -lsundials_nvecserial -lipopt -lcoinmumps -lpthread -lm -lgfortranbegin -lgfortran -lmingw32 -lgcc_eh -lmoldname -lmingwex -lmsvcrt -luser32 -lkernel32 -ladvapi32 -lshell32 -llapack-mingw -lcminpack -ltmglib-mingw -lblas-mingw -lf2c -linteractive -lwsock32 -llis -lstdc++ 
...
omc_main_target: $(MAINOBJ) ICSolar.ICS_Skeleton_functions.h ICSolar.ICS_Skeleton_literals.h $(OFILES)
	$(CC) -I. -o ICSolar.ICS_Skeleton$(EXEEXT) $(MAINOBJ) $(OFILES) $(CPPFLAGS) -L"C:/Users/Justin/Documents/GitHub/RPI_CASE_ICS_Modelica"  -lModelicaStandardTables $(CFLAGS) $(LDFLAGS)
clean:
