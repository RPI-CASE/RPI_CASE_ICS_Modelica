...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_17.c

.PHONY: Buildings_getAbsolutePath_17
Buildings_getAbsolutePath_17: $(MAINFILE) Buildings_getAbsolutePath_17.h Buildings_getAbsolutePath_17_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_17.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_17_records.o Buildings_getAbsolutePath_17_records.c
	 $(LINK) -o Buildings_getAbsolutePath_17$(DLLEXT) Buildings_getAbsolutePath_17.o Buildings_getAbsolutePath_17_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm