...
PERL=perl
MAINFILE=Buildings_getLongitudeTMY3_2.c

.PHONY: Buildings_getLongitudeTMY3_2
Buildings_getLongitudeTMY3_2: $(MAINFILE) Buildings_getLongitudeTMY3_2.h Buildings_getLongitudeTMY3_2_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getLongitudeTMY3_2.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getLongitudeTMY3_2_records.o Buildings_getLongitudeTMY3_2_records.c
	 $(LINK) -o Buildings_getLongitudeTMY3_2$(DLLEXT) Buildings_getLongitudeTMY3_2.o Buildings_getLongitudeTMY3_2_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm