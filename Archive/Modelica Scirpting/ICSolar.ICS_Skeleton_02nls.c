 ...
 */
void ICSolar_ICS_Skeleton_eqFunction_2056(DATA *data)
{
...
void initializeStaticNLSData2058(void *inData, void *inNlsData)
{
...
void residualFunc2058(void* dataIn, const double* xloc, double* res, const int* iflag)
{
  DATA* data = (DATA*) dataIn;
  const int equationIndexes[2] = {1,2058};
  $Pics_context1$PweatherBus$PTWetBul = xloc[0];
  ICSolar_ICS_Skeleton_eqFunction_2056(data);
...
/*
 ...
 ics_context1._weaDat._tWetBul_TDryBulXi._XiSat = DIVISION(0.621964713077499, -0.378035286922501 + 0.001634903221903779 * ics_context1.weaDat.pAtm * exp(-17.2799 - DIVISION(-4102.99, -35.719 + ics_context1.weatherBus.TWetBul)))
 */
void ICSolar_ICS_Skeleton_eqFunction_4776(DATA *data)
{
...
void initializeStaticNLSData4778(void *inData, void *inNlsData)
{
  DATA* data = (DATA*) inData;
  NONLINEAR_SYSTEM_DATA* nlsData = (NONLINEAR_SYSTEM_DATA*) inNlsData;
  int i=0;
...
void residualFunc4778(void* dataIn, const double* xloc, double* res, const int* iflag)
{
  DATA* data = (DATA*) dataIn;
...
void ICSolar_ICS_Skeleton_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA* nonLinearSystemData)
{
  ...
  nonLinearSystemData[0].equationIndex = 2058;
  nonLinearSystemData[0].size = 1;
  nonLinearSystemData[0].method = 0;
  nonLinearSystemData[0].residualFunc = residualFunc2058;
  nonLinearSystemData[0].analyticalJacobianColumn = NULL;
  nonLinearSystemData[0].initialAnalyticalJacobian = NULL;
  nonLinearSystemData[0].jacobianIndex = -1;
  nonLinearSystemData[0].initializeStaticNLSData = initializeStaticNLSData2058;
  assertStreamPrint(NULL, nNonLinearSystems > 1, "Internal Error: nNonLinearSystems mismatch!");
  nonLinearSystemData[1].equationIndex = 4778;
  nonLinearSystemData[1].size = 1;
  nonLinearSystemData[1].method = 0;
  nonLinearSystemData[1].residualFunc = residualFunc4778;
  nonLinearSystemData[1].analyticalJacobianColumn = NULL;
  nonLinearSystemData[1].initialAnalyticalJacobian = NULL;
  nonLinearSystemData[1].jacobianIndex = -1;
  nonLinearSystemData[1].initializeStaticNLSData = initializeStaticNLSData4778;
}
