...
PERL=perl
MAINFILE=Buildings_getHeaderElementTMY3_12.c

.PHONY: Buildings_getHeaderElementTMY3_12
Buildings_getHeaderElementTMY3_12: $(MAINFILE) Buildings_getHeaderElementTMY3_12.h Buildings_getHeaderElementTMY3_12_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_12.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_12_records.o Buildings_getHeaderElementTMY3_12_records.c
	 $(LINK) -o Buildings_getHeaderElementTMY3_12$(DLLEXT) Buildings_getHeaderElementTMY3_12.o Buildings_getHeaderElementTMY3_12_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm