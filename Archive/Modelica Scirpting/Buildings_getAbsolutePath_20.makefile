...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_20.c

.PHONY: Buildings_getAbsolutePath_20
Buildings_getAbsolutePath_20: $(MAINFILE) Buildings_getAbsolutePath_20.h Buildings_getAbsolutePath_20_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_20.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_20_records.o Buildings_getAbsolutePath_20_records.c
	 $(LINK) -o Buildings_getAbsolutePath_20$(DLLEXT) Buildings_getAbsolutePath_20.o Buildings_getAbsolutePath_20_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm