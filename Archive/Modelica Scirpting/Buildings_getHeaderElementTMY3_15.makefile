...
PERL=perl
MAINFILE=Buildings_getHeaderElementTMY3_15.c

.PHONY: Buildings_getHeaderElementTMY3_15
Buildings_getHeaderElementTMY3_15: $(MAINFILE) Buildings_getHeaderElementTMY3_15.h Buildings_getHeaderElementTMY3_15_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_15.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_15_records.o Buildings_getHeaderElementTMY3_15_records.c
	 $(LINK) -o Buildings_getHeaderElementTMY3_15$(DLLEXT) Buildings_getHeaderElementTMY3_15.o Buildings_getHeaderElementTMY3_15_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm