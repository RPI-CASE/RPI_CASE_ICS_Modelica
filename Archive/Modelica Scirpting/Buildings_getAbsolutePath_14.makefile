...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_14.c

.PHONY: Buildings_getAbsolutePath_14
Buildings_getAbsolutePath_14: $(MAINFILE) Buildings_getAbsolutePath_14.h Buildings_getAbsolutePath_14_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_14.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_14_records.o Buildings_getAbsolutePath_14_records.c
	 $(LINK) -o Buildings_getAbsolutePath_14$(DLLEXT) Buildings_getAbsolutePath_14.o Buildings_getAbsolutePath_14_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm