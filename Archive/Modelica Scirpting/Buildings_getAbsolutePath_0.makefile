...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_0.c

.PHONY: Buildings_getAbsolutePath_0
Buildings_getAbsolutePath_0: $(MAINFILE) Buildings_getAbsolutePath_0.h Buildings_getAbsolutePath_0_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_0.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_0_records.o Buildings_getAbsolutePath_0_records.c
	 $(LINK) -o Buildings_getAbsolutePath_0$(DLLEXT) Buildings_getAbsolutePath_0.o Buildings_getAbsolutePath_0_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm