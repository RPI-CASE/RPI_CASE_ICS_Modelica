...
PERL=perl
MAINFILE=Buildings_getHeaderElementTMY3_7.c

.PHONY: Buildings_getHeaderElementTMY3_7
Buildings_getHeaderElementTMY3_7: $(MAINFILE) Buildings_getHeaderElementTMY3_7.h Buildings_getHeaderElementTMY3_7_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_7.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_7_records.o Buildings_getHeaderElementTMY3_7_records.c
	 $(LINK) -o Buildings_getHeaderElementTMY3_7$(DLLEXT) Buildings_getHeaderElementTMY3_7.o Buildings_getHeaderElementTMY3_7_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm