...
Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_GasProperties_rettype omc_Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_GasProperties(threadData_t *threadData, modelica_real MM, modelica_real R, modelica_real cp, modelica_real cv)
{
  Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_GasProperties_rettype tmp1;
  Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_GasProperties tmp2;
  tmp2._MM = MM;
  tmp2._R = R;
  tmp2._cp = cp;
  tmp2._cv = cv;
...
Buildings_BoundaryConditions_WeatherData_BaseClasses_getAbsolutePath_rettype omc_Buildings_BoundaryConditions_WeatherData_BaseClasses_getAbsolutePath(threadData_t *threadData, modelica_string _uri)
{
    ...
    if((!tmp6.c1))
    {
      ...
      if((!tmp9.c1))
      {
        ...
        if(!tmp12.c1)
        {
            ...
            FILE_INFO info = {"C:\\OpenModelica1.9.1Beta2\\lib\\omlibrary\\Buildings 2.1.0\\BoundaryConditions\\WeatherData\\BaseClasses\\getAbsolutePath.mo",32,9,35,57,0};
  ...
  else
  {
    ...
    if(!tmp22.c1)
    {
        ...
        FILE_INFO info = {"C:\\OpenModelica1.9.1Beta2\\lib\\omlibrary\\Buildings 2.1.0\\BoundaryConditions\\WeatherData\\BaseClasses\\getAbsolutePath.mo",42,5,42,87,0};
...
Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_FluidConstants_rettype omc_Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_FluidConstants(threadData_t *threadData, modelica_string iupacName, modelica_string casRegistryNumber, modelica_string chemicalFormula, modelica_string structureFormula, modelica_real molarMass, modelica_real criticalTemperature, modelica_real criticalPressure, modelica_real criticalMolarVolume, modelica_real acentricFactor, modelica_real meltingPoint, modelica_real normalBoilingPoint, modelica_real dipoleMoment, modelica_boolean hasIdealGasHeatCapacity, modelica_boolean hasCriticalData, modelica_boolean hasDipoleMoment, modelica_boolean hasFundamentalEquation, modelica_boolean hasLiquidHeatCapacity, modelica_boolean hasSolidHeatCapacity, modelica_boolean hasAccurateViscosityData, modelica_boolean hasAccurateConductivityData, modelica_boolean hasVapourPressureCurve, modelica_boolean hasAcentricFactor, modelica_real HCRIT0, modelica_real SCRIT0, modelica_real deltah, modelica_real deltas)
{
  Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_FluidConstants_rettype tmp1;
  Buildings_Utilities_Psychrometrics_TWetBul__TDryBulPhi_Medium_FluidConstants tmp2;
  tmp2._iupacName = iupacName;
  tmp2._casRegistryNumber = casRegistryNumber;
  tmp2._chemicalFormula = chemicalFormula;
  tmp2._structureFormula = structureFormula;
  tmp2._molarMass = molarMass;
  tmp2._criticalTemperature = criticalTemperature;
  tmp2._criticalPressure = criticalPressure;
  tmp2._criticalMolarVolume = criticalMolarVolume;
  tmp2._acentricFactor = acentricFactor;
  tmp2._meltingPoint = meltingPoint;
  tmp2._normalBoilingPoint = normalBoilingPoint;
  tmp2._dipoleMoment = dipoleMoment;
  tmp2._hasIdealGasHeatCapacity = hasIdealGasHeatCapacity;
  tmp2._hasCriticalData = hasCriticalData;
  tmp2._hasDipoleMoment = hasDipoleMoment;
  tmp2._hasFundamentalEquation = hasFundamentalEquation;
  tmp2._hasLiquidHeatCapacity = hasLiquidHeatCapacity;
  tmp2._hasSolidHeatCapacity = hasSolidHeatCapacity;
  tmp2._hasAccurateViscosityData = hasAccurateViscosityData;
  tmp2._hasAccurateConductivityData = hasAccurateConductivityData;
  tmp2._hasVapourPressureCurve = hasVapourPressureCurve;
  tmp2._hasAcentricFactor = hasAcentricFactor;
  tmp2._HCRIT0 = HCRIT0;
  tmp2._SCRIT0 = SCRIT0;
  tmp2._deltah = deltah;
  tmp2._deltas = deltas;
...
ICSolar_round_rettype omc_ICSolar_round(threadData_t *threadData, modelica_real _r)
{
  ...
  /* functionBodyRegularFunction: var inits */
  /* functionBodyRegularFunction: body */
  tmp4 = (modelica_boolean)(_r > 0.0);
  if(tmp4)
  {
    tmp2 = floor((0.5 + _r));
    tmp5 = ((modelica_integer)floor(tmp2));
  }
  else
  {
    tmp3 = ceil((_r + -0.5));
    tmp5 = ((modelica_integer)floor(tmp3));
  }
  _i = tmp5;
  _return: OMC_LABEL_UNUSED
  /* functionBodyRegularFunction: out var copy */
...
ICSolar_ShadingFraction__Index_rettype omc_ICSolar_ShadingFraction__Index(threadData_t *threadData, modelica_integer _rowType, modelica_integer _colType, modelica_real _arrayPitch, modelica_real _arrayYaw)
{
  /* functionBodyRegularFunction: arguments */
  /* functionBodyRegularFunction: locals */
  ICSolar_ShadingFraction__Index_rettype tmp1;
  ...
  ICSolar_roundn_rettype tmp2;
  ICSolar_roundn_rettype tmp3;
  ICSolar_round_rettype tmp4;
  _tailrecursive: OMC_LABEL_UNUSED
  /* functionBodyRegularFunction: out inits */
  /* functionBodyRegularFunction: var inits */
  _Max_angle = 1.25664;
  ...
  tmp2 = omc_ICSolar_roundn(threadData, _arrayPitch_2, 0.05236);
  _arrayPitch_2 = tmp2.c1;

  tmp3 = omc_ICSolar_roundn(threadData, _arrayYaw_2, 0.05236);
  _arrayYaw_2 = tmp3.c1;

  _Index = (1201.0 + ((0.2 * ((modelica_real)((modelica_integer) 60025 * ((modelica_integer) -1 + (modelica_integer)_rowType)))) + ((0.04 * ((modelica_real)((modelica_integer) 60025 * ((modelica_integer) -1 + (modelica_integer)_colType)))) + ((-935.83 * _arrayPitch_2) + (19.099 * _arrayYaw_2)))));

  tmp4 = omc_ICSolar_round(threadData, _Index);
  _SFraction_Index = ((modelica_real)tmp4.c1);
  _return: OMC_LABEL_UNUSED
  /* functionBodyRegularFunction: out var copy */
  /* functionBodyRegularFunction: out var assign */
  tmp1.c1 = _SFraction_Index;
  /* GC: pop the mark! */
  /* functionBodyRegularFunction: return the outs */
  return  tmp1;
}
...
{
  Modelica_Media_Interfaces_Types_IdealGas_FluidConstants_rettype tmp1;
  Modelica_Media_Interfaces_Types_IdealGas_FluidConstants tmp2;
  tmp2._iupacName = iupacName;
  tmp2._casRegistryNumber = casRegistryNumber;
  tmp2._chemicalFormula = chemicalFormula;
  tmp2._structureFormula = structureFormula;
...
Modelica_Media_IdealGases_Common_DataRecord_rettype omc_Modelica_Media_IdealGases_Common_DataRecord(threadData_t *threadData, modelica_string name, modelica_real MM, modelica_real Hf, modelica_real H0, modelica_real Tlimit, real_array alow, real_array blow, real_array ahigh, real_array bhigh, modelica_real R)
{
  Modelica_Media_IdealGases_Common_DataRecord_rettype tmp1;
  Modelica_Media_IdealGases_Common_DataRecord tmp2;
  tmp2._name = name;
  tmp2._MM = MM;
  tmp2._Hf = Hf;
  tmp2._H0 = H0;
