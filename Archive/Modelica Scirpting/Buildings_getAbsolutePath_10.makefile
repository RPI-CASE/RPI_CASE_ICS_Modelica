...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_10.c

.PHONY: Buildings_getAbsolutePath_10
Buildings_getAbsolutePath_10: $(MAINFILE) Buildings_getAbsolutePath_10.h Buildings_getAbsolutePath_10_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_10.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_10_records.o Buildings_getAbsolutePath_10_records.c
	 $(LINK) -o Buildings_getAbsolutePath_10$(DLLEXT) Buildings_getAbsolutePath_10.o Buildings_getAbsolutePath_10_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm