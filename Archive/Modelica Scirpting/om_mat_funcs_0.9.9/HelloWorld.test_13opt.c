...
extern "C" {
#endif
int HelloWorld_test_mayer(DATA* data, modelica_real** res,short *i){return -1;}
int HelloWorld_test_lagrange(DATA* data, modelica_real** res, short * i1, short*i2){return -1;}
