...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_3.c

.PHONY: Buildings_getAbsolutePath_3
Buildings_getAbsolutePath_3: $(MAINFILE) Buildings_getAbsolutePath_3.h Buildings_getAbsolutePath_3_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_3.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_3_records.o Buildings_getAbsolutePath_3_records.c
	 $(LINK) -o Buildings_getAbsolutePath_3$(DLLEXT) Buildings_getAbsolutePath_3.o Buildings_getAbsolutePath_3_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm