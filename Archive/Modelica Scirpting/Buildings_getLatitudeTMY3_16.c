#include "Buildings_getLatitudeTMY3_16.h"
...
#define _OMC_LIT5_data "Error when converting the latitude '"
static const char _OMC_LIT5[37] = _OMC_LIT5_data;
#define _OMC_LIT6_data "' from a String to a Real."
static const char _OMC_LIT6[27] = _OMC_LIT6_data;
#define _OMC_LIT7_data "Wrong value for latitude. Received lat = "
static const char _OMC_LIT7[42] = _OMC_LIT7_data;
...
#include "Buildings_getLatitudeTMY3_16_includes.h"
...
modelica_real omc_Buildings_BoundaryConditions_WeatherData_BaseClasses_getLatitudeTMY3(threadData_t *threadData, modelica_string _filNam)
{
  ...
  TRACE_PUSH
  _element = omc_Buildings_BoundaryConditions_WeatherData_BaseClasses_getHeaderElementTMY3(threadData, _filNam, _OMC_LIT3, _OMC_LIT4, (modelica_integer) 7);

  /* tuple assignment nexInd, lat*/
  ...
  if(!((modelica_integer)_nexInd > (modelica_integer) 1))
  {
      ...
      FILE_INFO info = {"C:/OpenModelica1.9.1/lib/omlibrary/Buildings 1.6/BoundaryConditions/WeatherData/BaseClasses/getLatitudeTMY3.mo",22,4,23,62,0};
      omc_assert(threadData, info, tmp2);
  }

  _lat = (0.0174532925199433 * _lat);

  if(!(fabs(_lat) <= 3.141592653589794))
  {
      tmp3 = modelica_real_to_modelica_string(_lat, (modelica_integer) 0, 1, (modelica_integer) 6);
      tmp4 = cat_modelica_string(_OMC_LIT7,tmp3);
      tmp5 = cat_modelica_string(tmp4,_OMC_LIT8);
      tmp6 = modelica_real_to_modelica_string((57.29577951308232 * _lat), (modelica_integer) 0, 1, (modelica_integer) 6);
      tmp7 = cat_modelica_string(tmp5,tmp6);
      tmp8 = cat_modelica_string(tmp7,_OMC_LIT9);
      FILE_INFO info = {"C:/OpenModelica1.9.1/lib/omlibrary/Buildings 1.6/BoundaryConditions/WeatherData/BaseClasses/getLatitudeTMY3.mo",27,4,29,84,0};
...
DLLExport
int in_Buildings_BoundaryConditions_WeatherData_BaseClasses_getLatitudeTMY3(type_description * inArgs, type_description * outVar)
{
  ...
  write_modelica_real(outVar, &_lat);
  fflush(NULL);
  return 0;
}
...
int main(int argc, char **argv) {
...

  {
    ...
    omc_Buildings_BoundaryConditions_WeatherData_BaseClasses_getLatitudeTMY3(threadData, lst);
