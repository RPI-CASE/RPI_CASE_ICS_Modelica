...
PERL=perl
MAINFILE=Buildings_getAbsolutePath_9.c

.PHONY: Buildings_getAbsolutePath_9
Buildings_getAbsolutePath_9: $(MAINFILE) Buildings_getAbsolutePath_9.h Buildings_getAbsolutePath_9_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_9.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getAbsolutePath_9_records.o Buildings_getAbsolutePath_9_records.c
	 $(LINK) -o Buildings_getAbsolutePath_9$(DLLEXT) Buildings_getAbsolutePath_9.o Buildings_getAbsolutePath_9_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm