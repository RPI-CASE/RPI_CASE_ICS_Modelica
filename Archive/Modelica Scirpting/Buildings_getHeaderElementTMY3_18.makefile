...
PERL=perl
MAINFILE=Buildings_getHeaderElementTMY3_18.c

.PHONY: Buildings_getHeaderElementTMY3_18
Buildings_getHeaderElementTMY3_18: $(MAINFILE) Buildings_getHeaderElementTMY3_18.h Buildings_getHeaderElementTMY3_18_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_18.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_18_records.o Buildings_getHeaderElementTMY3_18_records.c
	 $(LINK) -o Buildings_getHeaderElementTMY3_18$(DLLEXT) Buildings_getHeaderElementTMY3_18.o Buildings_getHeaderElementTMY3_18_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm