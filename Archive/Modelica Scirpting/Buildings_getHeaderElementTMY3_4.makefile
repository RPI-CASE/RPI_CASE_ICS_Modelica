...
PERL=perl
MAINFILE=Buildings_getHeaderElementTMY3_4.c

.PHONY: Buildings_getHeaderElementTMY3_4
Buildings_getHeaderElementTMY3_4: $(MAINFILE) Buildings_getHeaderElementTMY3_4.h Buildings_getHeaderElementTMY3_4_records.c
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_4.o $(MAINFILE)
	 $(CC) $(CFLAGS) -c -o Buildings_getHeaderElementTMY3_4_records.o Buildings_getHeaderElementTMY3_4_records.c
	 $(LINK) -o Buildings_getHeaderElementTMY3_4$(DLLEXT) Buildings_getHeaderElementTMY3_4.o Buildings_getHeaderElementTMY3_4_records.o -lModelicaExternalC $(CFLAGS) $(LDFLAGS) -lm