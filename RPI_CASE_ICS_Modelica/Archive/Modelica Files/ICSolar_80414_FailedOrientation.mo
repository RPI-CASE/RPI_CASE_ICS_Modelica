package ICSolar "Package of all the necessary components to create an Integrated Concentrating Solar simulation"
  ...
  equation
    // connect(ics_context1.Orientation,ics_envelopecassette1.Orientation);
    ics_envelopecassette1.Orientation = ics_context1.Orientation;
  ...
  model ICS_Context
    ...
    parameter Modelica.SIunits.Angle SurfOrientation = Buildings.HeatTransfer.Types.Azimuth.S "Change 'S' to 'W','E', or 'N' for other orientations";
    parameter Modelica.SIunits.Angle SurfTilt = Buildings.HeatTransfer.Types.Tilt.Ceiling "Change 'Ceiling' to 'Wall' or 'Floor' for other configurations";
    ...
    output Modelica.SIunits.Angle Orientation annotation(Placement(visible = false));
  equation
    Orientation = SurfOrientation;
  ...
  package Envelope "Package of all the Envelope components to create an Integrated Concentrating Solar simulation"
    ...
    model ICS_EnvelopeCassette
      ...
      input Modelica.SIunits.Angle Orientation annotation(Placement(visible = false));
    equation
      // connect(Orientation,ics_selfshading1.Orientation);
      ics_selfshading1.Orientation = Orientation;
