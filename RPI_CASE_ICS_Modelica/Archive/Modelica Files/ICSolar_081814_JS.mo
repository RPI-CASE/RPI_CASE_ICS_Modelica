package ICSolar "Package of all the necessary components to create an Integrated Concentrating Solar simulation"
  ...
  equation
    ...
    connect(ics_context1.SurfAzi,ics_envelopecassette1.SurfAzi) "connects solar azimuth on a install surface" annotation(Line(points = {{-70,14},{-38.0282,14},{-38.0282,15.7277},{-10,15.7277},{-10,16}}));
    connect(ics_context1.SurfAlt,ics_envelopecassette1.SurfAlt) "connects solar altitude on the installed surface" annotation(Line(points = {{-70,16},{-40.1408,16},{-40.1408,18.3099},{-10,18.3099},{-10,18}}));
  ...
  model ICS_Context "This model provides the pieces necessary to set up the context to run the simulation, in FMU practice this will be cut out and provided from the EnergyPlus file"
    ...
    Modelica.Blocks.Interfaces.RealOutput SurfAlt "Solar altitude in relation to the tilt of the surface" annotation(Placement(visible = true, transformation(origin = {100,-60}, extent = {{-10,-10},{10,10}}, rotation = 0), iconTransformation(origin = {100,-40}, extent = {{-10,-10},{10,10}}, rotation = 0)));
    Modelica.Blocks.Interfaces.RealOutput SurfAzi "Solar azimuth in relation to the oriention of the surface" annotation(Placement(visible = true, transformation(origin = {100,-80}, extent = {{-10,-10},{10,10}}, rotation = 0), iconTransformation(origin = {100,-60}, extent = {{-10,-10},{10,10}}, rotation = 0)));
  ...
  package Envelope "Package of all the Envelope components to create an Integrated Concentrating Solar simulation"
    ...
    model ICS_EnvelopeCassette "This model in the Envelope Cassette (Double-Skin Facade) that houses the ICSolar Stack and Modules. This presents a building envelope"
      ...
      Modelica.Blocks.Interfaces.RealInput SurfAlt "Altitude of the sun in relation to the surface" annotation(Placement(visible = true, transformation(origin = {-100,-20}, extent = {{-10,-10},{10,10}}, rotation = 0), iconTransformation(origin = {-100,-20}, extent = {{-10,-10},{10,10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput SurfAzi "Azimuth of the sun in relation to the surface" annotation(Placement(visible = true, transformation(origin = {-100,-40}, extent = {{-10,-10},{10,10}}, rotation = 0), iconTransformation(origin = {-100,-40}, extent = {{-10,-10},{10,10}}, rotation = 0)));
    ...
    equation
      ...
      connect(SurfAzi,ics_selfshading1.SurfAzi) "Piping solar azimuth to selfshading for calculations" annotation(Line(points = {{-100,-40},{-67.92449999999999,-40},{-67.92449999999999,8.12772},{-35.4136,8.12772},{-35.4136,8.12772}}));
      connect(SurfAlt,ics_selfshading1.SurfAlt) "Piping solar altitude to selfshading for calculations" annotation(Line(points = {{-100,-20},{-75.762,-20},{-75.762,14.2235},{-35.7039,14.2235},{-35.7039,14.2235}}));
