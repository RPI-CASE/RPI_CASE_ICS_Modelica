package ICSolar "Integrated Concentrating Solar simulation, packaged for hierarchy construction"
  ...
  model ICS_Skeleton "This model calculates the electrical and thermal generation of ICSolar. This model is used as a skeleton piece to hold together the other models until it is packages as an FMU."
    ...
    Real measured_DNI = IC_Data_all.y[1] * 89 / 68;
    ...
    Real GN_arrayTotal = ics_envelopecassette1.ics_stack1.ICS_Module_Twelve_1[1].G_DN_mod * 10;
    // ^^^ END OF MEASURED ^^^
    //*********************
    ///////////////////////
    /// Modeled Results ///
    ...
    Real temp_flowport_b = abs(ics_envelopecassette1.ics_stack1.ICS_Module_Twelve_1[1].modulereceiver1.water_Block_HX1.flowport_b1.H_flow / (measured_vFlow * mediumHTF.rho * mediumHTF.cp));
    // Energy / Exergy / Eta / Epsilon
    // ARRAY TOTALS
    Real Qgen_arrayTotal = abs(ics_envelopecassette1.ics_stack1.ICS_Module_Twelve_1[1].modulereceiver1.water_Block_HX1.flowport_b1.H_flow) - ics_envelopecassette1.flowport_a.H_flow;
  ...
  package Module "Package of all the necessary components to create an Integrated Concentrating Solar simulation"
    ...
    model ICS_Module_Twelve "This model contains all the components and equations that simulate one module of Integrated Concentrating Solar"
      ...
      Real measured_eGen_on = 1;
      // Assume all are fully active and cogeneraubg
      // assume always on
