...
void initializeStaticNLSData1853(void *inData, void *inNlsData)
{
...
void residualFunc1853(void* dataIn, double* xloc, double* res, integer* iflag)
{
  DATA* data = (DATA*) dataIn;
  const int equationIndexes[2] = {1,1853};
  modelica_real tmp3401;
  #ifdef _OMC_MEASURE_TIME
  SIM_PROF_ADD_NCALL_EQ(modelInfoXmlGetEquation(&data->modelData.modelDataXml,1853).profileBlockIndex,1);
  #endif
  ...
  tmp3401 = exp((17.2799 + DIVISION_SIM(-4102.99,(-35.719 + $Pics_context1$PweatherBus$PTWetBul),"-35.719 + ics_context1.weatherBus.TWetBul",equationIndexes)));
  res[1] = (-0.621964713077499 + ($Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiSat * (-0.378035286922501 + DIVISION_SIM($Pics_context1$PweaDat$PpAtm,(tmp3401 * 611.657),"exp(17.2799 + DIVISION(-4102.99, -35.719 + ics_context1.weatherBus.TWetBul)) * 611.657",equationIndexes))));
}
void initializeStaticNLSData4637(void *inData, void *inNlsData)
{
  DATA* data = (DATA*) inData;
  NONLINEAR_SYSTEM_DATA* nlsData = (NONLINEAR_SYSTEM_DATA*) inNlsData;
  int i=0;
...
void residualFunc4637(void* dataIn, double* xloc, double* res, integer* iflag)
{
  DATA* data = (DATA*) dataIn;
  const int equationIndexes[2] = {1,4637};
  modelica_real tmp3402;
  #ifdef _OMC_MEASURE_TIME
  SIM_PROF_ADD_NCALL_EQ(modelInfoXmlGetEquation(&data->modelData.modelDataXml,4637).profileBlockIndex,1);
  #endif
  $Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiSat = xloc[0];
  $Pics_context1$PweatherBus$PTWetBul = xloc[1];
  res[0] = (($Pics_context1$PweatherBus$PTWetBul * ((1006.0 * (1.0 - $Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiSat)) + (1860.0 * $Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiSat))) + (((-$Pics_context1$PTOutside$PT) * ((1006.0 * (1.0 - $Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiDryBul)) + (1860.0 * $Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiDryBul))) + (-2501014.5 * ($Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiDryBul - $Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiSat))));
  tmp3402 = exp((17.2799 + DIVISION_SIM(-4102.99,(-35.719 + $Pics_context1$PweatherBus$PTWetBul),"-35.719 + ics_context1.weatherBus.TWetBul",equationIndexes)));
  res[1] = (-0.621964713077499 + ($Pics_context1$PweaDat$PtWetBul_TDryBulXi$PXiSat * (-0.378035286922501 + DIVISION_SIM($Pics_context1$PweaDat$PpAtm,(tmp3402 * 611.657),"exp(17.2799 + DIVISION(-4102.99, -35.719 + ics_context1.weatherBus.TWetBul)) * 611.657",equationIndexes))));
}
...
{
  nonLinearSystemData[0].equationIndex = 1853;
  nonLinearSystemData[0].size = 2;
  nonLinearSystemData[0].method = 0;
  nonLinearSystemData[0].residualFunc = residualFunc1853;
  nonLinearSystemData[0].analyticalJacobianColumn = NULL;
  nonLinearSystemData[0].initialAnalyticalJacobian = NULL;
  nonLinearSystemData[0].jacobianIndex = -1;
  nonLinearSystemData[0].initializeStaticNLSData = initializeStaticNLSData1853;
  
  nonLinearSystemData[1].equationIndex = 4637;
  nonLinearSystemData[1].size = 2;
  nonLinearSystemData[1].method = 0;
  nonLinearSystemData[1].residualFunc = residualFunc4637;
  nonLinearSystemData[1].analyticalJacobianColumn = NULL;
  nonLinearSystemData[1].initialAnalyticalJacobian = NULL;
  nonLinearSystemData[1].jacobianIndex = -1;
  nonLinearSystemData[1].initializeStaticNLSData = initializeStaticNLSData4637;
