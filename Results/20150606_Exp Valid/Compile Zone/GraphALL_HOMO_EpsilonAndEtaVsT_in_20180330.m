...
% t_o_ = trimmed the observed data into the right length for charting
...
errorbar(t_o_Tin(1:nthElement:end)',t_o_eta_Qgen(1:nthElement:end)',error_eta,...
    'Marker','s',...
    'MarkerSize',8,...
    'LineStyle','-',...
    'Color',Color,...
