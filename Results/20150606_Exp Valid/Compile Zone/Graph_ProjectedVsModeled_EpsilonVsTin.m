...
load('PROJECTED_ICSolar.ICS_Skeleton_20_Feb_2015_v5.mat','chi_arrayTotal',...
    'Ex_epsilon_Cgen_6mods','Start','End','day','measured_T_HTFin',...
    'measured_T_cavAvg','G_DN_6mods','eta_Cgen_6mods',...
...
T_HTFin = [350-273 300-273 325-273 375-273 400-273];
predict_eps = [0.4002 .3774 .3942 .3981 .3887];
