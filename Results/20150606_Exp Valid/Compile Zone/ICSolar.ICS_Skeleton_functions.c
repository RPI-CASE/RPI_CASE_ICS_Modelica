...
ICSolar_Water__75degC_rettype omc_ICSolar_Water__75degC(threadData_t *threadData, modelica_real rho, modelica_real cp, modelica_real cv, modelica_real lamda, modelica_real nue)
{
  ICSolar_Water__75degC_rettype tmp1;
  ICSolar_Water__75degC tmp2;
  tmp2._rho = rho;
  tmp2._cp = cp;
  tmp2._cv = cv;
  tmp2._lamda = lamda;
