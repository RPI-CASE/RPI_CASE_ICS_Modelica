%% Function compute the UQ for the measured eta Cgen
...
x = (t_o_Qgen + t_o_Egen) ./(t_o_Gdn_mod + t_o_Gdn_mod23);


per_err_1 = mean (s_eta_Cgen_mod6./t_o_eta_Cgen6);
per_err_2 = mean (s_eta_Cgen_mod23./t_o_eta_Cgen23);
per_err = mean (s_eta_Cgen./t_o_eta_Cgen);
% 
% 
% 
