...
out_eta_Cgen_proj_at58C = mean(eta_Cgen_arrayTotal(Tlook_58C_start:Tlook_58C_end));
out_eta_Cgen_proj_at70C = mean(eta_Cgen_arrayTotal(Tlook_70C_start:Tlook_70C_end));
out_eta_Cgen_proj_at80C = mean(eta_Cgen_arrayTotal(Tlook_80C_start:Tlook_80C_end));

out_eta_Egen_proj_at58C = mean(eta_Egen_arrayTotal(Tlook_58C_start:Tlook_58C_end));
out_eta_Egen_proj_at70C = mean(eta_Egen_arrayTotal(Tlook_70C_start:Tlook_70C_end));
out_eta_Egen_proj_at80C = mean(eta_Egen_arrayTotal(Tlook_80C_start:Tlook_80C_end));

out_eta_Qgen_proj_at58C = mean(eta_Qgen_arrayTotal(Tlook_58C_start:Tlook_58C_end));
out_eta_Qgen_proj_at70C = mean(eta_Qgen_arrayTotal(Tlook_70C_start:Tlook_70C_end));
out_eta_Qgen_proj_at80C = mean(eta_Qgen_arrayTotal(Tlook_80C_start:Tlook_80C_end));
