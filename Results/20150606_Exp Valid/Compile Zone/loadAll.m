...
load('ICSolar.ICS_Skeleton_20_Feb_2015_v4.mat','Egen_arrayTotal',...
...
load('ICSolar.ICS_Skeleton_19_Mar_2015_v4.mat','Egen_arrayTotal',...
    'measured_Egen_arrayTotal','Qgen_arrayTotal','measured_Qgen_arrayTotal',...
    'Start','End')
%trimmed observed 
...
load('ICSolar.ICS_Skeleton_23_Mar_2015_v4.mat','Egen_arrayTotal',...
    'measured_Egen_arrayTotal','Qgen_arrayTotal','measured_Qgen_arrayTotal',...
    'Start','End')
%trimmed observed 
temp1 = measured_Egen_arrayTotal(Start:End);
