%% Function compute the UQ for the measured Q Gen
...
upper =  t_o_Qgen + s_Qgen;
lower = t_o_Qgen - s_Qgen;

per_err_1 = mean (s_Qgen_mod6./t_o_Qgen6);
per_err_2 = mean (s_Qgen_mod23./t_o_Qgen23);
per_err = mean (s_Qgen./t_o_Qgen);
