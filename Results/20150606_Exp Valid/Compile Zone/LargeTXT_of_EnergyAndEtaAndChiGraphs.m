...
% Plot Heat
plot(t_s_eta_Qgen,'LineStyle',':',...
    'Color',[1 0 0],...
    'DisplayName','eta Qgen',...
    'LineWidth',3);

% Plot Eletrical
plot(t_s_eta_Egen,'LineStyle',':',...
    'Color',Turquoise,...
    'DisplayName','eta Egen',...
    'LineWidth',3);

% Plot Combined
plot(t_s_eta_Com,'LineStyle',':',...
    'Color',Purple,...
    'DisplayName','eta Combined',...
    'LineWidth',3);
...
% Create ylabel
ylabel('\eta_{(module conversion efficiency)}',...
   'FontName','Arial Narrow',...
    'FontSize',20,...
    'FontWeight','bold');
set(gca,'YGrid','on',...
