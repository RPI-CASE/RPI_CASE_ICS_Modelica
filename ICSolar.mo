package ICSolar "Integrated Concentrating Solar simulation, packaged for hierarchy construction"
  ...
  equation
    ...
    annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-200, -100}, {200, 100}}), graphics), experiment(StartTime = 0, StopTime = 3.15569e5, Tolerance = 1e-06, Interval = 3600));
  end ICS_Skeleton;
  ...
  package Envelope "Package of all the Envelope components to create an Integrated Concentrating Solar simulation"
    ...
    equation
      if AOI <= 1.570795 then
        //1.57 then
        // 1.57079632679 then
        //Modelica.Constants.pi / 2.0 then
