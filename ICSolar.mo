...
package ICSolar
  ...
  model ICS_Skeleton
    ...
    Modelica.Thermal.FluidHeatFlow.Sources.Ambient Source(medium = mediumHTF, useTemperatureInput = false, constantAmbientPressure = 101325, constantAmbientTemperature = TAmb)
      "Thermal fluid source"                                                                                                     annotation(Placement(visible = true, transformation(origin = {-60, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    //[[20150211]]
    ...
    Modelica.Thermal.FluidHeatFlow.Sources.VolumeFlow Pump(constantVolumeFlow = OneBranchFlow, m = 0.1, medium = mediumHTF, T0 = TAmb, T0fixed = false)
      "Fluid pump for thermal fluid"                                                                                                     annotation(Placement(visible = true, transformation(origin = {-20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(ics_envelopecassette1.flowport_b, Sink.flowPort) annotation(Line(points={{45,40},
            {60.0812,40},{60.0812,-20.2977},{70,-20.2977},{70,-20}},                                                                                                    color = {255, 0, 0}));
    connect(Source.flowPort, Pump.flowPort_a) annotation(Line(points = {{-50, -20}, {-34, -20}, {-30, -20}}));
    connect(Pump.flowPort_b, ics_envelopecassette1.flowport_a) annotation(Line(points = {{-10, -20}, {-4.3554, -20}, {-4.3554, 17.6597}, {6.25, 18.75}, {-3.75, 18.75}}));
  ...
  package Envelope
    ...
    model ICS_EnvelopeCassette
      ...
      ICSolar.Envelope.ICS_SelfShading ics_selfshading1 annotation(Placement(visible = true, transformation(origin = {-16, 4}, extent = {{-17.5, -17.5}, {17.5, 17.5}}, rotation = 0)));
      ...
      Modelica.Blocks.Interfaces.RealOutput Power_Electric
        "Electric power generated"                                                    annotation(Placement(visible = true, transformation(origin = {100, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      ICSolar.Envelope.ICS_GlazingLosses glazingLossesOuter(Trans_glaz = 0.74) annotation(Placement(visible = true, transformation(origin = {-60, 60}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
    ...
    equation
      connect(glazingLossesOuter.SurfDirNor, ics_selfshading1.DNI_in) annotation(Line(points={{-45,63},
              {-40.5439,63},{-40.5439,18.047},{-33.5,18.047},{-33.5,18}},                                                                                                    color = {0, 0, 127}));
      connect(ics_stack1.flowport_b1, flowport_b) annotation(Line(points = {{65, 0}, {80, 0}, {80, -21.2245}, {100, -21.2245}, {100, -20}}, color = {255, 0, 0}));
      ics_stack1.Power_in = 0;
      //  connect(GND.y, ics_stack1.Power_in) annotation(Line(points = {{-9, -60}, {-4.35374, -60}, {-4.35374, -21.4966}, {16.3265, -21.4966}, {16.3265, -21.4966}}, color = {0, 0, 127}));
      ...
      // connect(dnireduction_areafraction1.arrayYaw, rotationmatrixforsphericalcood1.arrayYaw) annotation(Line(points = {{-30, -56}, {-35.102, -56}, {-34.8548, -14.0504}, {-49.7528, -14.445}, {-50, -14}}, color = {0, 0, 127}));
      ...
      connect(rotationmatrixforsphericalcood1.arrayYaw, ics_selfshading1.arrayYaw) annotation(Line(points = {{-50, -14}, {-46.5555, -14.445}, {-46.8027, 7.34694}, {-33.5, 7.34694}, {-33.5, 11}}, color = {0, 0, 127}));
      connect(rotationmatrixforsphericalcood1.arrayPitch, ics_selfshading1.arrayPitch) annotation(Line(points = {{-50, -24}, {-42.4739, -24.445}, {-42.7211, -0.544218}, {-33.5, -0.544218}, {-33.5, 4}}, color = {0, 0, 127}));
      ...
      // connect(glazingLossesInner.SurfDirNor, DNI_toIndoors) annotation(Line(points = {{75, -57}, {80.5442, -57}, {80.5442, -79.4558}, {100, -79.4558}, {100, -80}}, color = {0, 0, 127}));
      // connect(AOI, glazingLossesInner.AOI) annotation(Line(points = {{-100, 40}, {-79.4558, 40}, {-79.4558, -77.551}, {12.2449, -77.551}, {12.2449, -69.932}, {45, -69.932}, {45, -69}}, color = {0, 0, 127}));
      ...
      connect(flowport_a, ics_stack1.flowport_a1) annotation(Line(points = {{-100, -80}, {5.78072, -80}, {5.78072, -13.5009}, {15, -13.5009}, {15, -15}}));
      connect(ics_selfshading1.DNI_out, ics_stack1.DNI) annotation(Line(points = {{1.5, 7.5}, {6, 7.5}, {6, -8}, {17.5, -8}, {17.5, -8.5}}));
      // simply multiply the stack.power_out by NumOfStacks to get array production
      ics_stack1.Power_out * NumOfStacks = Power_Electric;
      //  connect(ics_stack1.Power_out, Power_Electric) annotation(Line(points = {{65, 10}, {80.9074, 10}, {80.9074, 18.9036}, {100, 18.9036}, {100, 20}}));
      annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics={  Text(origin = {14, -9}, extent = {{-82, 57}, {65, -44}}, textString = "Envelope")}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics), experiment(StartTime = 0, StopTime = 3.1536e+07, Tolerance = 1e-06, Interval = 3600));
  ...
  package Stack
    ...
    model ICS_Stack
      ...
      input Modelica.Blocks.Interfaces.RealInput Power_in(start = 0)
        "Power input to stack from (GND?)"                                                              annotation(Placement(visible = true, transformation(origin = {-100, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-90, -86}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput DNI "DNI in from Envelope (Parent)" annotation(Placement(visible = true, transformation(origin = {-100, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-90, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Thermal.FluidHeatFlow.Interfaces.FlowPort_a flowport_a1(medium = mediumHTF)
        "Thermal fluid inflow port"                                                                                    annotation(Placement(visible = true, transformation(origin = {-100, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    equation
      ...
      annotation(Placement(transformation(extent = {{-10, 64}, {10, 84}})), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = false, initialScale = 0.1, grid = {2, 2}), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0},
                fillPattern =                                                                                                    FillPattern.VerticalCylinder, fillColor = {215, 215, 215}), Text(origin = {0.95, 5.29}, extent = {{-61.06, 40.08}, {61.06, -40.08}}, textString = "Stack"), Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0})}), Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Rectangle(extent = {{-100, 100}, {100, -100}}, lineColor = {0, 0, 0})}), experiment(StartTime = 0, StopTime = 315360, Tolerance = 1e-06, Interval = 3710.12));
    end ICS_Stack;
  end Stack;
  ...
  package Module
    ...
    model ICS_PVPerformance
      ...
      Modelica.Blocks.Interfaces.RealInput ConcentrationFactor
        "Used to represent 'suns's for the calculation of PVEfficiency"                                                        annotation(Placement(visible = true, transformation(origin = {-100, -60}, extent = {{-25, -25}, {25, 25}}, rotation = 0), iconTransformation(origin = {-100, -60}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
      ...
      Modelica.Blocks.Interfaces.RealInput DNI_in
        "DNI in from the Lens model (include Concentration)"                                           annotation(Placement(visible = true, transformation(origin = {-100, 20}, extent = {{-25, -25}, {25, 25}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-15, -15}, {15, 15}}, rotation = 0)));
    equation
      ...
      ThermalGen.Q_flow = -EIPC * (1 - CellEfficiency)
        "Energy left over after electrical gen is converted to heat";
...
<p> The F-number for a Fresnal-Köhler lens is the ratio of the distance between cell and Fresenel lens to the diagonal measurement of the front lens. The concentrator optical efficiency is defined as the ratio of power on the cell to the power on the entry aperture when the sun is exactly on-axis.</p>
  ...
  model Parameters
    ...
    parameter Real OpticalEfficiency = 0.57
      "The optical efficiency of the concentrating lens and optics prior to the photovoltaic cell";
    ...
    ///// TEMPERATURES /////
    ////////////////////////
    parameter Real Temp_Indoor = 23 + 273.15
    ...
    parameter Real Conv_WaterTube = 3.66 * 0.58 / (2 * 0.003175) * 2 * Modelica.Constants.pi * 0.003175 * 0.3
      "Convection Heat Transfer of Water to Piping = h*SurfArea = Nu(=3.66) * kofWater / Diameter * Surface Area";
    parameter Real Conv_InsulationAir = 3.66 * 0.023 / (2 * (0.003175 + 0.0015 + 0.09525)) * 2 * Modelica.Constants.pi * (0.003175 + 0.0015 + 0.01905) * 0.3
      "Convection Heat Transfer of Piping to Air Nu(=3.66) * kofAir / Diameter * Surface Area";
    parameter Real Cond_Insulation = 1 / (Modelica.Math.log(14.2 / 4.675) / (2 * Modelica.Constants.pi * 0.037 * 0.3) * 2 * Modelica.Constants.pi * (0.003175 + 0.0015 + 0.01905) * 0.3)
      "Thermal conductivity of Tubing Insulation: ln((23.55e-3)/(4.5e-3))/(2*pi*0.037*0.3)";
    parameter Real Cond_Tube = 1 / (Modelica.Math.log(4.675 / 3.175) / (2 * Modelica.Constants.pi * 0.145 * 0.3) * 2 * Modelica.Constants.pi * (0.003175 + 0.0015) * 0.3)
