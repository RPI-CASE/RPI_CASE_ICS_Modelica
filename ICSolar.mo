package ICSolar "Integrated Concentrating Solar simulation, packaged for hierarchy construction"
  ...
  equation
    ...
    annotation(Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-200, -100}, {200, 100}}), graphics), experiment(StartTime = 7.123e+06, StopTime = 7.1475e+06, Tolerance = 1e-06, Interval = 120.098));
  end ICS_Skeleton;
  ...
  package Envelope "Package of all the Envelope components to create an Integrated Concentrating Solar simulation"
    ...
    equation
      connect(prescribedtemperature1.port, cavityheatbalance1.Tcav_measured) annotation(Line(points = {{-10, 100}, {-2.657, 100}, {-2.657, 52.657}, {10.1449, 52.657}, {10.1449, 52.657}}, color = {191, 0, 0}));
      connect(Tcav_measured, prescribedtemperature1.T) annotation(Line(points = {{-60, 100}, {-32.1256, 100}, {-32.1256, 99.0338}, {-32.1256, 99.0338}}, color = {0, 0, 127}));
      ...
      connect(TAmb_in, cavityheatbalance1.Exterior) annotation(Line(points = {{-100, 80}, {5.04451, 80}, {5.04451, 65.8754}, {10, 66}, {10, 66}}));
      connect(DNI, glazingLossesOuter.DNI) annotation(Line(points = {{-100, 60}, {-75, 60}, {-75, 64}, {-70, 69}, {-75, 69}}));
      connect(tubing_losses1.flowport_b1, ics_stack2.flowport_a1) annotation(Line(points = {{70, -60}, {72.01649999999999, -60}, {72.01649999999999, -27.9835}, {4.73251, -27.9835}, {4.73251, -15.4321}, {15.0206, -15.4321}, {15.0206, -15.4321}}, color = {255, 0, 0}));
  ...
  package Module "Package of all the necessary components to create an Integrated Concentrating Solar simulation"
    ...
    model ICS_Module "This model contains all the components and equations that simulate one module of Integrated Concentrating Solar"
      ...
      ICSolar.Receiver.moduleReceiver modulereceiver1 "Heat Receiver to calculate the heat transfer between heat gen and heat transfered to thermal fluid" annotation(Placement(visible = true, transformation(origin = {60, 0}, extent = {{-15, -8.57143}, {15, 21.4286}}, rotation = 0)));
    equation
  ...
  model Parameters "Inputs for the ICSF model"
    ...
    parameter Real Resistivity_WaterPlate = 1 "Thermal resisitivity of the water plate heat exchanger";
    parameter Real Cond_RecToEnv = 0.1 "This is a thermal conductivity to determine the amount of heat lost to the environment from the receiver";
    //parameter Real Conv_Receiver = 0.0534;
    parameter Real Conv_Receiver = 5;
